    ...
    <div className="container">
      ...
      <div className="main-content">
        ...
        <section id="corsi">
          ...
          <p>
            Corsi base di astrologia e tarocchi, counseling astro-psico-genealogico ad personam e seminari esperienziali per Anime Abili!
          </p>
        </section>
